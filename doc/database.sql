...
CREATE TABLE `order` (
  ...
  KEY `client_id___fk` (`client_id`),
  CONSTRAINT `client_id___fk` FOREIGN KEY (`client_id`) REFERENCES `clients` (`client_id`)
...
INSERT INTO `order` VALUES (1,17.00,285,NULL),(2,17.00,286,NULL),(3,17.00,287,NULL),(4,17.00,288,NULL),(5,17.00,289,NULL),(6,17.00,290,NULL),(7,47.00,291,NULL),(8,10.00,292,NULL),(9,10.00,293,NULL),(10,10.00,294,NULL),(11,27.00,295,NULL),(12,27.00,296,NULL),(13,60.00,297,NULL),(14,27.00,298,NULL),(15,27.00,299,NULL),(16,27.00,300,NULL),(17,65.00,301,NULL),(18,17.00,302,NULL),(19,17.00,303,NULL),(20,17.00,304,NULL),(21,17.00,305,NULL),(22,17.00,306,NULL),(23,17.00,307,NULL),(24,10.00,308,NULL),(25,17.00,309,NULL),(26,17.00,310,NULL),(27,10.00,311,NULL),(28,27.00,312,'2023-12-30 12:01:49'),(29,17.00,313,'2023-12-30 13:36:33'),(30,27.00,314,'2023-12-30 15:00:09'),(31,10.00,315,'2023-12-30 16:47:35'),(32,17.00,316,'2023-12-30 16:48:27'),(33,17.00,317,'2023-12-30 16:49:32'),(34,17.00,318,'2023-12-30 16:55:57'),(35,10.00,319,'2023-12-30 17:01:46'),(36,10.00,320,'2023-12-30 17:12:48'),(37,10.00,321,'2023-12-30 17:42:22'),(38,17.00,322,'2023-12-30 17:48:38');
...
CREATE TABLE `order_services` (
  ...
  `service_id` int DEFAULT NULL,
  KEY `service_id__fk` (`service_id`),
  KEY `order_services_order_order_id_fk` (`order_id`),
  CONSTRAINT `order_services_order_order_id_fk` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`),
  CONSTRAINT `service_id__fk` FOREIGN KEY (`service_id`) REFERENCES `service` (`service_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_services` VALUES (10,1),(11,1),(11,2),(12,2),(12,1),(13,1),(13,3),(13,5),(14,2),(14,1),(15,2),(15,1),(16,2),(16,1),(17,5),(17,6),(17,1),(18,2),(19,2),(20,2),(21,2),(22,2),(23,2),(24,1),(25,2),(26,2),(27,1),(28,1),(28,2),(29,2),(30,2),(30,1),(31,1),(32,2),(33,2),(34,2),(35,1),(36,1),(37,1),(38,2);
...
-- Dump completed on 2023-12-30 19:29:00
